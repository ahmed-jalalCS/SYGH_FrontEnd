...
export default function StudentManagementPage() {
  ...
  const fetchGroups = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${API_BASE}/librarayStaff/students`, {
  ...
  const handleStudentUpdate = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `${API_BASE}/librarayStaff/students/${student.id}`,
        payload,
        { headers: getAuthHeaders() }
      );
  ...
  const confirmDeleteStudent = async () => {
    try {
      ...
      const res = await axios.delete(
        `${API_BASE}/librarayStaff/students/${id}`,
        {
          headers: getAuthHeaders(),
        }
      );
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      await axios.post(`${API_BASE}/librarayStaff/import-excel`, formData, {
        headers: getAuthHeaders(),
      ...
      >
            ...
            {filteredStudents.length > 0 ? (
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="p-3 text-center text-gray-600 font-medium w-24">
                          الإجراءات
                        </th>
                      </tr>
                    </thead>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center border border-gray-100">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  لم يتم العثور على طلاب يطابقون "{search}".
                </p>
              </div>
            )}
          </div>
          ...
          <>
            ...
            {groups.map((group, groupIdx) => (
              <div
                ...
                className="bg-white shadow-md rounded-lg mb-6 overflow-hidden border border-gray-100 transition-all hover:shadow-lg"
              >
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        <th className="text-center p-3 text-gray-600 font-medium w-24">
                          الإجراءات
                        </th>
                      </tr>
                    </thead>
                          ...
                          >
                            ...
                            <td className="p-3 text-center">
                              <div className="flex justify-center space-x-2">
                                ...
                                <button
                                  onClick={() =>
                                    setDeleteStudentConfirm(student)
                                  }
                                  className="text-red-600 hover:text-red-800 p-1 rounded-full hover:bg-red-50 transition-colors mx-2"
                                  title="حذف الطالب"
                                >
        ...
        {addStudentModal && (
          <div className="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50">
            <div
              className="bg-white p-6 rounded-lg w-full max-w-md shadow-lg transform transition-all"
              dir="rtl"
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      addStudentForm.graduation_year || new Date().getFullYear()
                    }
                    onChange={(e) =>
                      setAddStudentForm((prev) => ({
                        ...prev,
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    const group = groups.find(
                      (g) => g.project_id === addStudentModal.project_id
                    );
                    if (group) {
                      handleAddStudent(
                        addStudentModal.project_id,
                        group.department_id
                      );
                    } else {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    *اترك هذا الحقل فارغاً إذا لم ترغب بتغيير كلمة المرور
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  {deleteStudentConfirm.name}"؟ لا يمكن التراجع عن هذا الإجراء.
                </p>
              </div>
        ...
        {!loading && groups.length === 0 && !search.trim().length && (
          <div className="bg-white p-8 rounded-lg shadow-md text-center border border-gray-100">
            ...
            <p className="mt-1 text-sm text-gray-500">
              قم بإضافة طلاب جدد أو استخدم وظيفة استيراد ملف Excel.
            </p>
          </div>
        )}
      </div>
