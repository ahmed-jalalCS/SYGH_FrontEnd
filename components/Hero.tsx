...
const Hero = () => {
  const slides = [
    {
      image: "/images/image1.svg",
      title: "اكتشف مشاريع مدهشة",
      description:
        "استعرض مشاريع طلابية مبتكرة من أفضل الجامعات حول العالم. انضم إلى مجتمع العقول الإبداعية واستلهم من أفكار ثورية.",
      buttonText: "تصفح المشاريع",
      buttonLink: "/projects",
    },
    {
      image: "/images/blog.svg",
      title: "تواصل مع الجامعات",
      description:
        "اعثر على المسار التعليمي المناسب لك بين أفضل الجامعات. احصل على موارد شاملة واتخذ قرارات مستنيرة بشأن مستقبلك الأكاديمي.",
      buttonText: "عرض الجامعات",
      buttonLink: "/universities",
    },
    {
      image: "/images/testimonial.svg",
      title: "شارك ابتكاراتك",
      description:
        "أفكارك المبدعة تستحق الظهور. شارك مشاريعك مع جمهور عالمي وتواصل مع مبتكرين يشبهونك حول العالم.",
      buttonText: "إرسال مشروع",
      buttonLink: "/submit-project",
    },
  ];
